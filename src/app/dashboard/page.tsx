...
export default function DashboardPage() {
  ...
  const { setItineraryData, clearItinerary } = useItineraryStore();
  ...
  const fetchItineraries = async () => {
    ...
    try {
      // getUserItineraries now returns itineraries with createdAt as ISO string
  ...
  const handleViewItinerary = (itinerary: SavedItinerary) => {
    // itinerary.createdAt is already an ISO string from fetchItineraries
    setItineraryData(itinerary); // Pass directly as setItineraryData expects string or serializable
